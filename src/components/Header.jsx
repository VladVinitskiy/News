...
const Header = ({ user, isLoggedIn, checkAuthorize, changeEmail, changePassword, changePhone, removeCurrentUser, removeUser}) => {
                ...
                <nav className='navbar col-lg-8 col-md-8 col-sm-9 nav_mode navbar-expand-lg header_nav'>
                    <div className='dropdown'>
                        ...
                        <div className='dropdown-menu border-secondary dropdown-menu-right add p-lg-3 p-md-1 pb-sm-1'>
                            ...
                            <div className={isLoggedIn === false ? 'none' : 'user_data'}>
                            ...
                            <div className={isLoggedIn === true ? 'none' : 'container-fluid'}>
                            ...
                            <div className='container-fluid'>
                                <div className='row m-2'>
                                    <button
                                        className={isLoggedIn === false ? 'none' : 'btn btn-dark col-6'}
                                        onClick={() => {
                                    ...
                                    <Link
                                        className={isLoggedIn === true ? 'none' : 'btn btn-dark col-6'}
                                        to={`/signup`}>
                                        Sign Up
                                    </Link>
                                    <Link
                                        className={isLoggedIn === true ? 'none' : 'btn btn-light border-dark col-6'}
                                        to={`/login`}>
                                        Log in
                                    </Link>
                                    <button
                                        className={isLoggedIn === false ? 'none' : 'btn btn-light border-dark col-6'}
                                        onClick={(e) => {
                                            e.preventDefault();
                                            checkAuthorize(false);
                                            removeCurrentUser();
